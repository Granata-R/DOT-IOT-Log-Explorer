...
***[This short animation](https://i.imgur.com/tTH4YRX.gif)*** shows an example of interaction with the graphical user interface (GUI) of the main module. From it various "child" modules are available (see below).
